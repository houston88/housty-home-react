...
class TimelineBar extends React.Component {
  ...
  renderTimelineBar(elem, elemWidth, data) {
    ...
    svg.selectAll('bar')
        ...
        // Hmmm... probs with tooltip... still working through
        // .on('mouseover', (e) => {
        //   console.log('Hmm... what happened here?', d3.event)
        //   tip.show(e)
        // })
        // .on('mouseout', (e) => {
        //   tip.hide(e)
  ...
  createTooltip(d3) {
    ...
    tip.show = function() {
      ...
      coords = direction_callbacks.get(dir).apply(this, [d3.event])
    ...
    function direction_n(e) {
      var bbox = getScreenBBox(d3.event)
      return {
    ...
    function getScreenBBox(e) {
      var targetel   = target || e.target || d3.event.target;
